...
| 문서 버전 | 1.2 |
| 기준일 | 2026-03-31 |
| 개정 | 1.1 — H-8 미리보기 **미저장 미반영**(O-06). **1.2** — [`misc/기능목록.csv`](misc/기능목록.csv) v0.1(26.03.30) 요약을 **제10장**에 편입(기존 1~9장 유지). |
...
| 가시성 | 누가 콘텐츠를 볼 수 있는지(전체 공개, VIP 멤버십 등). |
...
- **비공개 전환 UI:** 질문지 미기재 → 제품 정책에서 정의([`fragments/cross-open-issues.md`](fragments/cross-open-issues.md) O-10).
...
| VIP 구독 | 홈 예시 **VIP 멤버십** ↔ 포스트 **VIP 구독** | 용어 통일 권장([`cross-open-issues.md`](fragments/cross-open-issues.md) O-11) |
...
- 「홈페이지 공개 중」 배너와 비공개 전환은 [`home-H1`](fragments/home-H1.md)·O-10 참고.
...
- **VIP 멤버십**(홈) / **VIP 구독**(포스트·상품) 등 짧은·긴 표기는 제품 사전에서 확정.
...
|----|------|
| O-10 | 홈 **비공개** 전환 UI 위치 |
| O-11 | VIP **멤버십** vs **구독** 표기 통일 |
| O-12 | 조각 내 `TBD` 일괄 수집 방식 |

**해결됨(O-01~O-09 등):** [`fragments/cross-open-issues.md`](fragments/cross-open-issues.md).
...
| 구분 | 역할 |
|------|------|
| 제1~9장·조각 | Figma 와이어·부록·O-01~O-11 등 **관측·결정** |
